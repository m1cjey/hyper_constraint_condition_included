  ...
  if (exponent == -1023) {
    ...
    for (i = 0; i < 52; i++) {
      if (no & 0x0008000000000000ll) {
        ...
        if(PRINTF_SW==1) printf("0");
      }
      no <<= 1;
    }
    if(PRINTF_SW==1) printf("_%d  (%d)", exponent, exponent - 1 - bottomi);
  }
}
*/
...
float number;
{
  ...
  if (exponent == -127) {
    if(PRINTF_SW==1) printf("0.00000000000000000000000_     (   )");
  } else {
    if(PRINTF_SW==1) printf("1.");
    bottomi = -1;
    for (i = 0; i < 23; i++) {
    ...
    if(PRINTF_SW==1) printf("_%3d  (%3d)", exponent, exponent - 1 - bottomi);
  }
}
*/
